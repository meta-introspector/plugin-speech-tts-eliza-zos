...
import { Service, IBrowserService, ServiceType, IAgentRuntime, ISpeechService, ITranscriptionService } from '@elizaos/core';
...
declare function createNodePlugin(): {
    ...
    readonly services: [BrowserService, SpeechService, TranscriptionService];
    readonly actions: [_elizaos_core.Action];
};

export { BrowserService, type NodePlugin, SpeechService, TranscriptionService, createNodePlugin };
